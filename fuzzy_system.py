import numpy as np
import math
from session3 import OmarFussySystem
...
class MyFuzzy_system:
    def __init__(self, ):

        self.sys = OmarFussySystem()

    def output(self, crisp_inputs):
        output = self.sys.set_input(crisp_inputs[0], crisp_inputs[2], crisp_inputs[1])
